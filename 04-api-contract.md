...
journaled, and a best-effort write, which `OVR-4` says "MUST NOT fail the work it records" —
the ledger repair after a reconcile pass (`API-24`) and the `Reclaim` row of a re-claim
